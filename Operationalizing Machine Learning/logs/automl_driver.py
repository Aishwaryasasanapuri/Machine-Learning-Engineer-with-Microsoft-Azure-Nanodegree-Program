...
workspace_name = "quick-starts-ws-133270" # PLACEHOLDER
subscription_id = "b968fb36-f06a-4c76-a15f-afab68ae7667" # PLACEHOLDER
resource_group = "aml-quickstarts-133270" # PLACEHOLDER
experiment_name = "Bank-market_automl" # PLACEHOLDER
iteration = "92"  # PLACEHOLDER
run_id = "AutoML_0664e575-b06a-4ece-a1a8-2ee67275ab2c_92"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'automl','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':60,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':60,'max_concurrent_iterations':5,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'Bank-market_automl','path':'./sample_projects/Bank-market_automl','primary_metric':'AUC_weighted','region':'southcentralus','resource_group':'aml-quickstarts-133270','subscription_id':'b968fb36-f06a-4c76-a15f-afab68ae7667','task_type':'classification','validation_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'quick-starts-ws-133270','label_column_name':'y','enable_pushmode_remote':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','ensemble_iterations':15,'is_timeseries':False,'name':'Bank-market_automl','compute_target':'automl','subscription_id':'b968fb36-f06a-4c76-a15f-afab68ae7667','region':'southcentralus'}\",\"ensemble_run_id\":\"AutoML_0664e575-b06a-4ece-a1a8-2ee67275ab2c_92\",\"experiment_name\":\"Bank-market_automl\",\"workspace_name\":\"quick-starts-ws-133270\",\"subscription_id\":\"b968fb36-f06a-4c76-a15f-afab68ae7667\",\"resource_group_name\":\"aml-quickstarts-133270\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"6d23cf32-def9-4c6b-84de-e16fecfbe5d2\"}}" # PLACEHOLDER
